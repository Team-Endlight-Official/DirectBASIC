...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("guitk_example", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("guitk_example", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.endlight.guitk";
		...
		#elseif air
		app.window.title = "GUI Toolkit Showcase";
		#else
