...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("dbaside", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("dbaside", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "dbaside";
		app.meta["name"] = "DirectBASIC Edit";
		app.meta["packageName"] = "com.endlight.dbaside";
		...
		#elseif air
		app.window.title = "DirectBASIC Edit";
		#else
